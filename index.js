...
// PAGE PIN KAR DIYA MEANS THODI DERR PAGE RUKEGA
gsap.to("#page", {
  scrollTrigger: {
    trigger: `#page`,
    start: `top top`,
...
function visionPro() {
  ...
  function files(index) {
    var data = `
      Apple canvas Images/Vision00001.png
      Apple canvas Images/Vision00002.png
      Apple canvas Images/Vision00003.png
      Apple canvas Images/Vision00004.png
      Apple canvas Images/Vision00005.png
      Apple canvas Images/Vision00006.png
      Apple canvas Images/Vision00007.png
      Apple canvas Images/Vision00008.png
      Apple canvas Images/Vision00009.png
      Apple canvas Images/Vision00010.png
      Apple canvas Images/Vision00011.png
      Apple canvas Images/Vision00012.png
      Apple canvas Images/Vision00013.png
      Apple canvas Images/Vision00014.png
      Apple canvas Images/Vision00015.png
      Apple canvas Images/Vision00016.png
      Apple canvas Images/Vision00017.png
      Apple canvas Images/Vision00018.png
      Apple canvas Images/Vision00019.png
      Apple canvas Images/Vision00020.png
      Apple canvas Images/Vision00021.png
      Apple canvas Images/Vision00022.png
      Apple canvas Images/Vision00023.png
      Apple canvas Images/Vision00024.png
      Apple canvas Images/Vision00025.png
   `;
    return data.split("\n")[index];
  }
